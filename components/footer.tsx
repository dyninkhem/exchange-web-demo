            ...
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2 md:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">Regulated blockchain infrastructure for enterprises.</p>
                    </div>
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} Paxos Trust Company, LLC, All rights reserved </span>
