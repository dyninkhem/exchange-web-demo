                ...
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div>
                        ...
                        <div className="mt-8 grid items-end gap-6 md:grid-cols-2">
                            <h2 className="text-foreground text-4xl font-semibold md:text-5xl">Four ways to unlock crypto for your users</h2>
                            <div className="lg:pl-12">
                                <p className="text-muted-foreground text-balance">Enterprise-ready solutions for embedding crypto trading, transfers, rewards, and payments into any platform.</p>
                            </div>
                        </div>
                    </div>
                    <div className="@xl:grid-cols-2 @3xl:grid-cols-3 mt-16 grid gap-2 *:shadow-lg *:shadow-black/5 lg:-mx-8">
                        <Card className="group grid grid-rows-[auto_1fr] gap-8 rounded-2xl p-8">
                            <div>
                                <h3 className="text-foreground font-semibold">Invest</h3>
                                <p className="text-muted-foreground mt-3">Empower your users to buy, sell, and hold 20+ digital assets — BTC, ETH, SOL, and more — directly within your platform.</p>
                            </div>
                        ...
                        <Card className="@xl:col-span-2 grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl px-8 pt-8">
                            <div className="max-w-md">
                                <h3 className="text-foreground font-semibold">Transfer</h3>
                                <p className="text-muted-foreground mt-3">Enable global, instant digital asset movement with on-chain and off-chain transfers, powered by institutional-grade infrastructure.</p>
                            </div>
                            <MapIllustration />
                        </Card>
                        ...
                        <Card className="@xl:@max-3xl:col-start-2 @max-3xl:row-start-1 group grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl p-8">
                            <div>
                                <h3 className="text-foreground font-semibold">Reward</h3>
                                <p className="text-muted-foreground mt-3">Drive engagement with crypto rewards, cashback programs, and loyalty incentives — all managed through a single API.</p>
                            </div>
                        ...
                        <div className="@xl:col-span-2 grid grid-rows-[1fr_auto] gap-2 !bg-transparent !shadow-none">
                            <div className="@xl:grid-cols-2 grid gap-2 *:shadow-lg *:shadow-black/5">
                                <Card className="group grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl p-8">
                                    <div>
                                        <h3 className="text-foreground font-semibold">Pay</h3>
                                        <p className="text-muted-foreground mt-3">Stablecoin-powered payment and settlement solutions that reduce costs and accelerate cross-border transactions.</p>
                                    </div>
                                ...
                                <Card className="group grid grid-rows-[auto_1fr] gap-8 overflow-hidden rounded-2xl p-8">
                                    <div>
                                        <h3 className="text-foreground font-semibold">Stablecoins</h3>
                                        <p className="text-muted-foreground mt-3">Mint, convert, and settle with USDP, PYUSD, and USDG — enterprise stablecoin infrastructure built for scale.</p>
                                    </div>
